...
public class CarAmphibia extends CombustionEngineVehicle implements Terrestrial, Aquatic {
    public CarAmphibia(Integer price, Colour colour, String vehicleName, Integer maxSpeed, CombustionEngine engine, int tankCapacity) {
