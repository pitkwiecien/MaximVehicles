...
public class FloatPlane extends EngineVehicle {
    private int maxHeight;

    public FloatPlane(Integer price, Colour colour, String vehicleName, Integer maxSpeed, Drive drive, int tankCapacity, int maxHeight) {
