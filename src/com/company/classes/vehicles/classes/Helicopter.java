...
public class Helicopter extends EngineVehicle {
    private int maxHeight;

    public Helicopter(Integer price, Colour colour, String vehicleName, Integer maxSpeed, Drive drive, int tankCapacity, int maxHeight) {
