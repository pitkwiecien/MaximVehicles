...
public class Sedan extends CombustionEngineVehicle implements Terrestrial {
    public Sedan(Integer price, Colour colour, String vehicleName, Integer maxSpeed, CombustionEngine engine, int tankCapacity) {
